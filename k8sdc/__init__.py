...
commands:
  ...
  up         run template, machine, provision, client, config, pull (not yet), and helm commands.
  ...
  pull       pull k8sdc solution images to the Docker repository cache. [NOT IMPLEMENTED]
